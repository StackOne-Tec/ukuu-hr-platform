/**
 * Full country list with E.164 dialing codes.
 * Used by the signup form: the country dropdown and the phone-number
 * country-code dropdown both derive from this single source of truth.
 */

export type Country = {
  /** Official English country name, alphabetical. */
  name: string;
  /** International dialing code, e.g. "+260". NANP territories use the full
      dialing sequence (e.g. "+1-242" for the Bahamas). */
  code: string;
};
...
/** Country names only — for simple selects. */
export const COUNTRY_NAMES: string[] = COUNTRIES.map((c) => c.name);

/** Default dialing code (matches the app's home market). */
export const DEFAULT_PHONE_CODE = "+260";